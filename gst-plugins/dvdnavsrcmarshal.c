...
void
dvdnavsrc_marshal_VOID__INT_INT (GClosure     *closure,
                                 GValue       *return_value,
...
void
dvdnavsrc_marshal_VOID__INT_INT_INT_INT (GClosure     *closure,
                                         GValue       *return_value,
                                         guint         n_param_values,
                                         const GValue *param_values,
                                         gpointer      invocation_hint,
...
void
dvdnavsrc_marshal_VOID__INT_INT_UINT_UINT_UINT_UINT_UINT_UINT (GClosure     *closure,
                                                               GValue       *return_value,
                                                               guint         n_param_values,
                                                               const GValue *param_values,
                                                               gpointer      invocation_hint,
                                                               gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__INT_INT_UINT_UINT_UINT_UINT_UINT_UINT) (gpointer     data1,
                                                                            gint         arg_1,
                                                                            gint         arg_2,
                                                                            guint        arg_3,
                                                                            guint        arg_4,
                                                                            ...
                                                                            guint        arg_8,
                                                                            gpointer     data2);
  register GMarshalFunc_VOID__INT_INT_UINT_UINT_UINT_UINT_UINT_UINT callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__INT_INT_UINT_UINT_UINT_UINT_UINT_UINT) (marshal_data ? marshal_data : cc->callback);
