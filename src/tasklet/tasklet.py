# Seamless DVD Player
# This file, Copyright (C) 2005 Gustavo J. A. M. Carneiro
#
# This file may contain modifications with respect to the original
# version. Please report problems to Martin Soto
# <martinsoto@users.sourceforge.net>
#
...
======================
  ...
  couple more requirements to regular generator functions:
    ...
    2. After each C{yield} that indicates events, the function
       L{tasklet.get_event} must be called to retrieve the event that
       just occurred.
...
===================
  ...
  Alternatively, L{tasklet.run} can be used to the same effect::
    import tasklet
